    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-6">
        ...
        <div className="relative max-w-4xl mx-auto">
          {/* Testimonial Card */}
          <div className="bg-gradient-to-br from-auttus-blue to-blue-900 rounded-2xl p-8 md:p-12 text-white shadow-2xl animate-fade-in">
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="mb-6 md:mb-0 md:mr-8">
                <img 
                  ...
                  className="w-24 h-24 rounded-full border-4 border-auttus-orange shadow-lg"
                />
              </div>
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="flex justify-center md:justify-start mb-4">
                  {[...Array(testimonials[currentIndex].rating)].map((_, i) => (
                    <Star key={i} className="h-5 w-5 text-auttus-orange fill-current" />
                  ))}
                </div>
          ...
          <div className="flex justify-center space-x-4 mt-8">
            <Button
              ...
              className="rounded-full border-auttus-blue text-auttus-blue hover:bg-auttus-blue hover:text-white"
            >
